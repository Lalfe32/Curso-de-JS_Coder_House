 ...
 * 2- Si se para un string, retornar el string "ARR!".
 * 3- Si se pasa cualquier otro tipo, retornar el mismo valor.
 */

//Para que una funcion sea anonima se le debe para primero la variable
// (const / let) variable = function (){ intruccion }

// const entrada = function (value) {
